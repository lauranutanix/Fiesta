...
ALTER USER 'root'@'localhost' IDENTIFIED BY 'Nutanix.123';
CREATE USER 'fiestauser'@'%' IDENTIFIED BY 'Nutanix.123';
...
mysql -u root -p'Nutanix.123' <<-EOF
...
INSERT INTO Products (product_name,product_price,product_image_url,product_comment) VALUES ('10 Champagne Flutes',4.50,'https://cdn.shmkdiopify.com/s/files/1/1832/6341/products/PLST_CU0071_GOLD_1000x.jpg?v=1571325883','Place an order with vendor of 24 packets by next Saturday.');
...
GRANT ALL PRIVILEGES ON fiestadb.* TO 'fiestauser'@'%';
